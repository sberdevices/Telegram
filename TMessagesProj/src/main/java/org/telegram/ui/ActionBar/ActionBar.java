...
public class ActionBar extends FrameLayout {
    ...
    private void createBackButtonImage() {
        ...
        backButtonImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
        ...
        backButtonImageView.setPadding(16, 16, 16, 16);
    ...
    private void createTitleTextView(int i) {
        ...
        titleTextView[i].setTypeface(AndroidUtilities.getTypeface("fonts/SBSansText-Regular.ttf"));
        ...
        for (int i = 0; i < 2; i++) {
            if (titleTextView[0] != null && titleTextView[0].getVisibility() != GONE || subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                ...
                if (subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                    subtitleTextView.setTextSize(24);
                }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int textLeft;
        int backButtonLeft = 24;
        if (backButtonImageView != null && backButtonImageView.getVisibility() != GONE) {
            backButtonImageView.layout(backButtonLeft, additionalTop, backButtonImageView.getMeasuredWidth() + backButtonLeft, additionalTop + backButtonImageView.getMeasuredHeight());
            textLeft = AndroidUtilities.dp(AndroidUtilities.isTablet() ? 80 : 72) + backButtonLeft;
        } else {
            textLeft = AndroidUtilities.dp(50);
        }

        int menuMarginEnd = 24;
        if (menu != null && menu.getVisibility() != GONE) {
            int menuLeft = isSearchFieldVisible ? AndroidUtilities.dp(AndroidUtilities.isTablet() ? 74 : 66) : (right - left) - menu.getMeasuredWidth() - menuMarginEnd;
